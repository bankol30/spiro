...
#define  AVG_NUM 8
#define MAINS_SCALE 0.6705882353 //edit this for actual voltage value
...
grid = (uint16_t)grid;
Serial.print("AC CURRENT:");Serial.print(current);Serial.println("A");
Serial.print("BATTERY:");Serial.print(battery);Serial.println("V");
Serial.print("MAINS:");Serial.print(grid);Serial.println("V");
delay(1000);
}
